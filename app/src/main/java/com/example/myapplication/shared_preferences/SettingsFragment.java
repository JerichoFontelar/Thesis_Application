...
//        if (context instanceof SharedPreferenceSourceProvider) {
//            sharedPrefDataSource = ((SharedPreferenceSourceProvider) context).getSharedPreferenceDataSource();
//        } else {
//            throw new RuntimeException(context.toString()
//                    + " must implement SharedPreferenceSourceProvider");
//        }
    }
...
//        // Get the root View from the inflated preference layout
//        View rootView = getView();
//        if (rootView != null) {
//            ((LinearLayout) rootView).setPadding(0, 0, 0, 65); // Set padding in dps (left, top, right, bottom)
//        }
        ...
        mapSettingsViewModel = new ViewModelProvider(this).get(MapSettingsViewModel.class);
        ...
        builder.setPositiveButton(
                ...
                new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        toast.show();
                        mapSettingsViewModel.triggerMapReload(); //Trigger map reload
